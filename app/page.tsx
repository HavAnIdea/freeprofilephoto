...
import { Sparkles, Heart, Smile, Cat, Palette, Wand2, Download, ArrowRight, Star } from 'lucide-react';
    ...
    <div className="min-h-screen overflow-hidden">
      ...
      <section className="container mx-auto px-4 pt-20 pb-32">
        ...
        >
          ...
          >
            Generate funny, cute, and stylish avatars instantly. No AI costs, no sign-up required.
            Choose from 50+ styles and download unlimited times - 100% free!
          </motion.p>
          ...
          >
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white transition-all duration-300 hover:shadow-2xl transition-transform duration-300 hover:scale-105 text-lg px-8 py-6 w-full sm:w-auto"
              asChild
            >
              <Link href="/cute">
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {['😂', '🥰', '😎', '🦊', '🐱', '🐼', '🎨', '✨'].map((emoji, i) => (
              <motion.div
                key={i}
                className="aspect-square rounded-2xl backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 border border-white/20 shadow-2xl flex items-center justify-center text-6xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl cursor-pointer"
                whileHover={{ scale: 1.05, rotate: [-5, 5, -5, 0] }}
                animate={{
                  y: [0, -10, 0],
                }}
                transition={{
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            Pick from our collection of avatar styles, all generated instantly with code
          </p>
        </motion.div>
          ...
          {features.map((feature, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="relative p-6 rounded-2xl backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 border border-white/20 shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-full transition-all duration-300 hover:shadow-2xl">
                    {/* Badge */}
                    {feature.badge && (
