  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <section className="container mx-auto px-4 pt-20 pb-32">
        ...
        >
          ...
          >
            Free Profile Photo
            <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 via-blue-500 via-green-500 via-yellow-500 to-red-500">Generator Online</span>
            <br />
            Create in Seconds
          </motion.h1>
          ...
          >
            Generate free profile photos for Instagram, TikTok, X, and Facebook. Create custom profile pictures instantly with our free profile photo maker. No sign-up required, no watermarks - 100% free forever!
          </motion.p>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          <Badge className="mb-4 bg-gradient-to-r from-cyan-500 to-purple-500 text-white border-0">
            ...
            Free Profile Photo Examples
          </Badge>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Free Profile Photos for <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">Social Media</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Create free profile photos perfect for Instagram, TikTok, X (Twitter), Facebook, and more. Our free profile photo generator makes it easy to design unique profile pictures that stand out on any social platform.
          </p>
        </motion.div>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Free Profile Photo <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">Styles</span>
          </h2>
          <p className="text-lg text-muted-foreground">
            Generate free profile photos in multiple styles. Create profile pictures for Instagram, TikTok, X, Facebook instantly
          </p>
        </motion.div>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            How to Create <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">Free Profile Photos</span>
          </h2>
          <p className="text-lg text-muted-foreground">
            Generate your free profile photo in 3 easy steps
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            {
              icon: Palette,
              title: '1. Choose Profile Photo Style',
              description: 'Select from funny, cute, cool styles for your free profile photo',
            },
            {
              icon: Wand2,
              title: '2. Customize Your Photo',
              description: 'Personalize colors, accessories, and expressions for your profile picture',
            },
            {
              icon: Download,
              title: '3. Download Free',
              description: 'Get your free profile photo instantly in high quality PNG format',
            },
          ].map((step, i) => {
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Start Creating Free
            <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 via-blue-500 via-green-500 via-yellow-500 to-red-500">Profile Photos Today</span>
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands creating free profile photos for Instagram, TikTok, X, and Facebook daily. Our free profile photo generator requires no credit card or sign-up. Generate unlimited profile pictures now!
          </p>
